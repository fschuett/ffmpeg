...
/**
 * <i>native declaration : ./libavcodec/avcodec.h:2326</i><br>
...
public class AVCodec extends StructObject {
	...
	/**
	 * Decode/encode API with decoupled packet/frame dataflow. The API is the<br>
	 ...
	 * - AVPacket parameter change side data is applied right before calling<br>
	 *   AVCodec->send_packet,<br>
	 * - if AV_CODEC_CAP_DELAY is not set, drain packets or frames are never sent,<br>
	 * - only one drain packet is ever passed down (until the next flush()),<br>
	 * - a drain AVPacket is always NULL (no need to check for avpkt->size).<br>
	...
	@Field(25) 
	public Pointer<AVCodec.send_packet_callback > send_packet() {
		return this.io.getPointerField(this, 25);
	}
	/** C type : send_packet_callback* */
	@Field(25) 
	public AVCodec send_packet(Pointer<AVCodec.send_packet_callback > send_packet) {
	...
	/** <i>native declaration : ./libavcodec/avcodec.h:2313</i> */
	...
	/** <i>native declaration : ./libavcodec/avcodec.h:2316</i> */
	...
	/** <i>native declaration : ./libavcodec/avcodec.h:2317</i> */
	...
	/** <i>native declaration : ./libavcodec/avcodec.h:2318</i> */
	...
	/** <i>native declaration : ./libavcodec/avcodec.h:2320</i> */
	...
	/** <i>native declaration : ./libavcodec/avcodec.h:2322</i> */
	...
	/** <i>native declaration : ./libavcodec/avcodec.h:2324</i> */
	...
	/** <i>native declaration : ./libavcodec/avcodec.h:2325</i> */
