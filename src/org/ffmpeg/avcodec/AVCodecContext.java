...
public class AVCodecContext extends StructObject {
	 ...
	 * To be accessed through av_codec_get_properties() (NO direct access)<br>
	 * - encoding: unused<br>
	 * - decoding: set by libavcodec
	 */
	@Field(200) 
	...
	/**
	 * Encoding only.<br>
	 * * For hardware encoders configured to use a hwaccel pixel format, this<br>
	 * field should be set by the caller to a reference to the AVHWFramesContext<br>
	 * describing input frames. AVHWFramesContext.format must be equal to<br>
	 * AVCodecContext.pix_fmt.<br>
	 * * This field should be set before avcodec_open2() is called and is<br>
	 * afterwards owned and managed by libavcodec.<br>
	 * C type : AVBufferRef*
	 */
	@Field(203) 
	...
	/** <i>native declaration : ./libavcodec/avcodec.h:2109</i> */
	...
	/** <i>native declaration : ./libavcodec/avcodec.h:2128</i> */
	...
	/** <i>native declaration : ./libavcodec/avcodec.h:2129</i> */
	...
	/** <i>native declaration : ./libavcodec/avcodec.h:2132</i> */
