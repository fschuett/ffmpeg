...
public class AVCodecContext extends StructObject {
	 ...
	 * Must be allocated with the av_malloc() family of functions.<br>
	 ...
	 * Must be allocated with the av_malloc() family of functions, and will be freed in<br>
	 * avcodec_free_context().<br>
	 * - encoding: Set/allocated by user, freed by libavcodec. Can be NULL.<br>
	 * - decoding: Set/allocated/freed by libavcodec.<br>
	 * C type : uint16_t*
	 */
	@Field(58) 
	 ...
	 * * If frame multithreading is used, this callback may be called from a<br>
	 * different thread, but not from more than one at once. Does not need to be<br>
	 * reentrant.<br>
	 ...
	 * - encoding: Set by libavcodec to the reordered_opaque of the input<br>
	 *             frame corresponding to the last returned packet. Only<br>
	 *             supported by encoders with the<br>
	 *             AV_CODEC_CAP_ENCODER_REORDERED_OPAQUE capability.<br>
	 * - decoding: Set by user.
	 */
	@Field(136) 
	...
	/**
	 * The percentage of damaged samples to discard a frame.<br>
	 * * - decoding: set by user<br>
	 * - encoding: unused
	 */
	@Field(190) 
	 ...
	 */
	@Field(190) 
	public AVCodecContext discard_damaged_percentage(int discard_damaged_percentage) {
		this.io.setIntField(this, 190, discard_damaged_percentage);
		return this;
	}
	/**
	 * The number of samples per frame to maximally accept.<br>
	 * * - decoding: set by user<br>
	 * - encoding: set by user
	 */
	@Field(191) 
	 ...
	 */
	@Field(191) 
	public AVCodecContext max_samples(long max_samples) {
		this.io.setLongField(this, 191, max_samples);
		return this;
	}
	/**
	 * Bit set of AV_CODEC_EXPORT_DATA_* flags, which affects the kind of<br>
	 * metadata exported in frame, packet, or coded stream side data by<br>
	 * decoders and encoders.<br>
	 * * - decoding: set by user<br>
	 * - encoding: set by user
	 */
	@Field(192) 
	 ...
	 */
	@Field(192) 
	public AVCodecContext export_side_data(int export_side_data) {
		this.io.setIntField(this, 192, export_side_data);
		return this;
	}
	/**
	 * This callback is called at the beginning of each packet to get a data<br>
	 * buffer for it.<br>
	 * * The following field will be set in the packet before this callback is<br>
	 * called:<br>
	 * - size<br>
	 * This callback must use the above value to calculate the required buffer size,<br>
	 * which must padded by at least AV_INPUT_BUFFER_PADDING_SIZE bytes.<br>
	 * * This callback must fill the following fields in the packet:<br>
	 * - data: alignment requirements for AVPacket apply, if any. Some architectures and<br>
	 *   encoders may benefit from having aligned data.<br>
	 * - buf: must contain a pointer to an AVBufferRef structure. The packet's<br>
	 *   data pointer must be contained in it. See: av_buffer_create(), av_buffer_alloc(),<br>
	 *   and av_buffer_ref().<br>
	 * * If AV_CODEC_CAP_DR1 is not set then get_encode_buffer() must call<br>
	 * avcodec_default_get_encode_buffer() instead of providing a buffer allocated by<br>
	 * some other means.<br>
	 * * The flags field may contain a combination of AV_GET_ENCODE_BUFFER_FLAG_ flags.<br>
	 * They may be used for example to hint what use the buffer may get after being<br>
	 * created.<br>
	 * Implementations of this callback may ignore flags they don't understand.<br>
	 * If AV_GET_ENCODE_BUFFER_FLAG_REF is set in flags then the packet may be reused<br>
	 * (read and/or written to if it is writable) later by libavcodec.<br>
	 * * This callback must be thread-safe, as when frame threading is used, it may<br>
	 * be called from multiple threads simultaneously.<br>
	 * * @see avcodec_default_get_encode_buffer()<br>
	 * * - encoding: Set by libavcodec, user can override.<br>
	 * - decoding: unused<br>
	 * C type : get_encode_buffer_callback*
	 */
	@Field(193) 
	public Pointer<AVCodecContext.get_encode_buffer_callback > get_encode_buffer() {
	 ...
	 */
	@Field(193) 
	public AVCodecContext get_encode_buffer(Pointer<AVCodecContext.get_encode_buffer_callback > get_encode_buffer) {
		this.io.setPointerField(this, 193, get_encode_buffer);
		return this;
	}
	/** <i>native declaration : ./libavcodec/avcodec.h:1357</i> */
	...
	/** <i>native declaration : ./libavcodec/avcodec.h:1377</i> */
	...
	/** <i>native declaration : ./libavcodec/avcodec.h:1378</i> */
	...
	/** <i>native declaration : ./libavcodec/avcodec.h:1379</i> */
	...
	/** <i>native declaration : ./libavcodec/avcodec.h:1380</i> */
	...
	/** <i>native declaration : ./libavcodec/avcodec.h:1381</i> */
	...
	/** <i>native declaration : ./libavcodec/avcodec.h:1390</i> */
	public static abstract class get_encode_buffer_callback extends Callback<get_encode_buffer_callback > {
		public int apply(Pointer<AVCodecContext > s, Pointer<AVPacket > pkt, int flags) {
			return apply(Pointer.getPeer(s), Pointer.getPeer(pkt), flags);
		}
		public int apply(@Ptr long s, @Ptr long pkt, int flags) {
