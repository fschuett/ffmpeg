...
/**
 * <i>native declaration : ./libavcodec/avcodec.h:134</i><br>
...
public class AVPacket extends StructObject {
	...
	@Field(7) 
	public Pointer<AVPacket.side_data_struct > side_data() {
		return this.io.getPointerField(this, 7);
	}
	/** C type : side_data_struct* */
	@Field(7) 
	public AVPacket side_data(Pointer<AVPacket.side_data_struct > side_data) {
	...
	public static class side_data_struct extends StructObject {
		static {
			BridJ.register();
		}
		/** C type : uint8_t* */
		...
		/** C type : uint8_t* */
		@Field(0) 
		public side_data_struct data(Pointer<Byte > data) {
		...
		@Field(1) 
		public side_data_struct size(int size) {
		...
		/** C type : AVPacketSideDataType */
		@Field(2) 
		public side_data_struct type(IntValuedEnum<AVPacketSideDataType > type) {
		...
		public side_data_struct(Pointer pointer) {
			super(pointer);
		}
	};
	public AVPacket() {
