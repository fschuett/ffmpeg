 ...
 * /home/fschuett/prog/java/eclipse/ffmpeg/csrc/libavformat
 * /../libavcodec/avcodec.h:1223</i><br>
...
public class AVCodecParser extends StructObject {
	...
	/** C type : parser_init_callback* */
	@Field(2)
	public AVCodecParser parser_init(
			Pointer<AVCodecParser.parser_init_callback> parser_init) {
	...
	/** C type : parser_parse_callback* */
	@Field(3)
	public AVCodecParser parser_parse(
			Pointer<AVCodecParser.parser_parse_callback> parser_parse) {
	...
	/** C type : parser_close_callback* */
	@Field(4)
	public AVCodecParser parser_close(
			Pointer<AVCodecParser.parser_close_callback> parser_close) {
	 ...
	 * <i>native declaration :
	 * /home/fschuett/prog/java/eclipse/ffmpeg/csrc/libavformat
	 * /../libavcodec/avcodec.h:1219</i>
	 */
	public static abstract class parser_init_callback extends
			Callback<parser_init_callback> {
		...
		public int apply(@Ptr long s) {
			return apply(Pointer
					.pointerToAddress(s, AVCodecParserContext.class));
		}
	};
	 ...
	 * <i>native declaration :
	 * /home/fschuett/prog/java/eclipse/ffmpeg/csrc/libavformat
	 * /../libavcodec/avcodec.h:1220</i>
	 */
	public static abstract class parser_parse_callback extends
			Callback<parser_parse_callback> {
		public int apply(Pointer<AVCodecParserContext> s,
				Pointer<AVCodecContext> avctx, Pointer<Byte> poutbuf,
				Pointer<Integer> poutbuf_size, Pointer<Byte> buf, int buf_size) {
			return apply(Pointer.getPeer(s), Pointer.getPeer(avctx),
					Pointer.getPeer(poutbuf), Pointer.getPeer(poutbuf_size),
					Pointer.getPeer(buf), buf_size);
		}

		public int apply(@Ptr long s, @Ptr long avctx, @Ptr long poutbuf,
				@Ptr long poutbuf_size, @Ptr long buf, int buf_size) {
			return apply(
					Pointer.pointerToAddress(s, AVCodecParserContext.class),
					Pointer.pointerToAddress(avctx, AVCodecContext.class),
					Pointer.pointerToAddress(poutbuf, Byte.class),
					Pointer.pointerToAddress(poutbuf_size, Integer.class),
					Pointer.pointerToAddress(buf, Byte.class), buf_size);
		}
	};
	 ...
	 * <i>native declaration :
	 * /home/fschuett/prog/java/eclipse/ffmpeg/csrc/libavformat
	 * /../libavcodec/avcodec.h:1221</i>
	 */
	public static abstract class parser_close_callback extends
			Callback<parser_close_callback> {
	 ...
	 * <i>native declaration :
	 * /home/fschuett/prog/java/eclipse/ffmpeg/csrc/libavformat
	 * /../libavcodec/avcodec.h:1222</i>
	 */
	public static abstract class split_callback extends
			Callback<split_callback> {
		public int apply(Pointer<AVCodecContext> avctx, Pointer<Byte> buf,
				int buf_size) {
