...
/**
 * <i>native declaration : ./libavcodec/avcodec.h:3902</i><br>
...
public abstract class AVBSFContext extends StructObject {
	...
	/**
	 * Parameters of the input stream. Set by the caller before av_bsf_init().<br>
	...
	/**
	 * Parameters of the output stream. Set by the filter in av_bsf_init().<br>
	 * C type : AVCodecParameters*
	 */
	@Field(5) 
