...
public class PostprocLibrary {
	...
	/**
	 * define<br>
	 * Conversion Error : 55.9.<br>
	 * SKIPPED:<br>
	 * <i>native declaration : ./libpostproc/version.h:0</i><br>
	 * 55.9.
	 */
	/** <i>native declaration : ./libpostproc/version.h</i> */
	public static final int LIBPOSTPROC_VERSION_MINOR = (int)9;
	/** <i>native declaration : ./libpostproc/version.h</i> */
	public static final String LIBPOSTPROC_IDENT = (String)"postproc55.9.100";
	/** <i>native declaration : ./libpostproc/version.h</i> */
	public static final int LIBPOSTPROC_BUILD = (int)((55) << 16 | (9) << 8 | (100));
	/** <i>native declaration : libpostproc/postprocess.h</i> */
	...
	/** <i>native declaration : ./libpostproc/version.h</i> */
	public static final int LIBPOSTPROC_VERSION_INT = (int)((55) << 16 | (9) << 8 | (100));
	/** <i>native declaration : libpostproc/postprocess.h</i> */
