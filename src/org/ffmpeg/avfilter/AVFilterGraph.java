...
/**
 * <i>native declaration : libavfilter/avfilter.h:940</i><br>
 * This file was autogenerated by <a href="http://jnaerator.googlecode.com/">JNAerator</a>,<br>
 * a tool written by <a href="http://ochafik.com/">Olivier Chafik</a> that <a href="http://code.google.com/p/jnaerator/wiki/CreditsAndLicense">uses a few opensource projects.</a>.<br>
 * For help, please visit <a href="http://nativelibs4java.googlecode.com/">NativeLibs4Java</a> or <a href="http://bridj.googlecode.com/">BridJ</a> .
 */
@Library("avfilter") 
public abstract class AVFilterGraph extends StructObject {
	static {
		BridJ.register();
	}
	...
	@Field(1) 
	public AVFilterGraph filter_count_unused(int filter_count_unused) {
		this.io.setIntField(this, 1, filter_count_unused);
		return this;
	}
	...
	public AVFilterGraph filters(Pointer<Pointer<AVFilterContext > > filters) {
		this.io.setPointerField(this, 2, filters);
		return this;
	}
	/**
	...
	public AVFilterGraph nb_filters(int nb_filters) {
		this.io.setIntField(this, 5, nb_filters);
		return this;
	}
	/**
	...
	public AVFilterGraph thread_type(int thread_type) {
		this.io.setIntField(this, 6, thread_type);
		return this;
	}
	/**
	...
	public AVFilterGraph nb_threads(int nb_threads) {
		this.io.setIntField(this, 7, nb_threads);
		return this;
	}
	/** Conversion Error : AVFilterGraphInternal* (failed to convert type to Java (undefined type)) */
	/**
	...
	public AVFilterGraph opaque(Pointer<? > opaque) {
		this.io.setPointerField(this, 9, opaque);
		return this;
	}
	/**
	...
	public AVFilterGraph execute(Pointer<avfilter_execute_func > execute) {
		this.io.setPointerField(this, 10, execute);
		return this;
	}
	/**
	...
	public AVFilterGraph aresample_swr_opts(Pointer<Byte > aresample_swr_opts) {
		this.io.setPointerField(this, 11, aresample_swr_opts);
		return this;
	}
	/** C type : AVFilterLink** */
	@Field(12) 
	...
	public AVFilterGraph sink_links(Pointer<Pointer<AVFilterLink > > sink_links) {
		this.io.setPointerField(this, 12, sink_links);
		return this;
	}
	@Field(13) 
	...
	public AVFilterGraph sink_links_count(int sink_links_count) {
		this.io.setIntField(this, 13, sink_links_count);
		return this;
	}
	@Field(14) 
	...
	public AVFilterGraph disable_auto_convert(int disable_auto_convert) {
		this.io.setIntField(this, 14, disable_auto_convert);
		return this;
	}
}
