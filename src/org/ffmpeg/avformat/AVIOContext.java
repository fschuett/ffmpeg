...
public class AVIOContext extends StructObject {
	...
	/**
	 * The following shows the relationship between buffer, buf_ptr,<br>
	 * buf_ptr_max, buf_end, buf_size, and pos, when reading and when writing<br>
	 * (since AVIOContext is used for both):<br>
	 * **********************************************************************************<br>
	 *                                   READING<br>
	 * *********************************************************************************<br>
	 * *                            |              buffer_size              |<br>
	 ...
	 *                             |/ / / / / / / / / / / /|              |<br>
	 *                             +-----------------------+--------------+<br>
	 *                               buf_ptr can be in this<br>
	 *                               due to a backward seek<br>
	 * *                            pos<br>
	 *               +-------------+----------------------------------------------+<br>
	 *  output file: |             |                                              |<br>
	 *               +-------------+----------------------------------------------+<br>
	...
	/**
	 * A callback that is used instead of write_packet.<br>
	...
	/**
	 * If set, don't call write_data_type separately for AVIO_DATA_MARKER_BOUNDARY_POINT,<br>
	 * but ignore them and treat them as AVIO_DATA_MARKER_UNKNOWN (to avoid needlessly<br>
	...
	/**
	 * Internal, not meant to be used from outside of AVIOContext.<br>
	...
	/**
	 * A callback that is used instead of short_seek_threshold.<br>
	 * This is current internal only, do not use from outside.<br>
	...
	public AVIOContext written(long written) {
		this.io.setLongField(this, 35, written);
		return this;
	}
	/**
	 * Maximum reached position before a backward seek in the write buffer,<br>
	 * used keeping track of already written data for a later flush.<br>
	 * C type : unsigned char*
	 */
	@Field(36) 
	...
	public AVIOContext buf_ptr_max(Pointer<Byte > buf_ptr_max) {
		this.io.setPointerField(this, 36, buf_ptr_max);
		return this;
	}
	...
	public AVIOContext min_packet_size(int min_packet_size) {
		this.io.setIntField(this, 37, min_packet_size);
		return this;
	}
	...
	/** <i>native declaration : libavformat/avio.h:254</i> */
	...
	public static abstract class write_data_type_callback extends Callback<write_data_type_callback > {
		...
		public int apply(@Ptr long opaque, @Ptr long buf, int buf_size, int type, long time) {
			return apply(Pointer.pointerToAddress(opaque), Pointer.pointerToAddress(buf, Byte.class), buf_size, FlagSet.fromValue(type, AVIODataMarkerType.class), time);
		}
	};
	/** <i>native declaration : libavformat/avio.h:262</i> */
