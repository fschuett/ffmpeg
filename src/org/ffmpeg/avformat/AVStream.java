...
public class AVStream extends StructObject {
	...
	/**
	 * a hack to keep ABI compatibility for ffmpeg and other applications, which accesses parser even<br>
	...
	public AVStream do_not_use(long do_not_use) {
		this.io.setLongField(this, 19, do_not_use);
		return this;
	}
	/**
	...
	public AVStream nb_decoded_frames(int nb_decoded_frames) {
		this.io.setIntField(this, 41, nb_decoded_frames);
		return this;
	}
	/**
	...
	public AVStream mux_ts_offset(long mux_ts_offset) {
		this.io.setLongField(this, 42, mux_ts_offset);
		return this;
	}
	...
	public AVStream pts_wrap_reference(long pts_wrap_reference) {
		this.io.setLongField(this, 43, pts_wrap_reference);
		return this;
	}
	/**
	...
	public AVStream pts_wrap_behavior(int pts_wrap_behavior) {
		this.io.setIntField(this, 44, pts_wrap_behavior);
		return this;
	}
	...
	public AVStream update_initial_durations_done(int update_initial_durations_done) {
		this.io.setIntField(this, 45, update_initial_durations_done);
		return this;
	}
	/**
	...
	public long last_dts_for_order_check() {
		return this.io.getLongField(this, 48);
	}
	/** Internal data to analyze DTS and detect faulty mpeg streams */
	@Field(48) 
	public AVStream last_dts_for_order_check(long last_dts_for_order_check) {
		this.io.setLongField(this, 48, last_dts_for_order_check);
		return this;
	}
	@Field(49) 
	...
	public AVStream dts_ordered(byte dts_ordered) {
		this.io.setByteField(this, 49, dts_ordered);
		return this;
	}
	@Field(50) 
	...
	public AVStream dts_misordered(byte dts_misordered) {
		this.io.setByteField(this, 50, dts_misordered);
		return this;
	}
	...
	public AVStream inject_global_side_data(int inject_global_side_data) {
		this.io.setIntField(this, 51, inject_global_side_data);
		return this;
	}
