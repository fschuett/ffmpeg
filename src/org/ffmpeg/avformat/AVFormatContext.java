...
public class AVFormatContext extends StructObject {
	 ...
	 * * Demuxing: Set by user.<br>
	 * * @deprecated Use io_open and io_close.<br>
	 ...
	 * * Certain muxers or demuxers (e.g. for various playlist-based formats) need<br>
	 * to open additional files during muxing or demuxing. This callback allows<br>
	 * the caller to provide custom IO in such cases.<br>
