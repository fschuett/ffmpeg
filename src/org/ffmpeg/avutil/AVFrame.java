...
/**
 * <i>native declaration : libavutil/frame.h:104</i><br>
...
public class AVFrame extends StructObject {
	...
	public AVFrame best_effort_timestamp(long best_effort_timestamp) {
		this.io.setLongField(this, 48, best_effort_timestamp);
		return this;
	}
	@Field(49) 
	public long pkt_pos() {
	...
	public AVFrame pkt_pos(long pkt_pos) {
		this.io.setLongField(this, 49, pkt_pos);
		return this;
	}
	@Field(50) 
	...
	public AVFrame pkt_duration(long pkt_duration) {
		this.io.setLongField(this, 50, pkt_duration);
		return this;
	}
	/** C type : AVDictionary* */
	@Field(51) 
	...
	public AVFrame metadata(Pointer<AVDictionary > metadata) {
		this.io.setPointerField(this, 51, metadata);
		return this;
	}
	@Field(52) 
	...
	public AVFrame decode_error_flags(int decode_error_flags) {
		this.io.setIntField(this, 52, decode_error_flags);
		return this;
	}
	@Field(53) 
	public int channels() {
	...
	public AVFrame channels(int channels) {
		this.io.setIntField(this, 53, channels);
		return this;
	}
	@Field(54) 
	public int pkt_size() {
	...
	public AVFrame qp_table_buf(Pointer<AVBufferRef > qp_table_buf) {
		this.io.setPointerField(this, 57, qp_table_buf);
		return this;
	}
	public AVFrame() {
		super();
