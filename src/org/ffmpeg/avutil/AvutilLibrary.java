...
public class AvutilLibrary {
	 ...
	 * /home/fschuett/prog/java/eclipse/ffmpeg/csrc/libavutil/avutil.h:11</i>
	 */
	 ...
	 * enum values<br>
	 * <i>native declaration :
	 * /home/fschuett/prog/java/eclipse/ffmpeg/csrc/libavutil/avutil.h:29</i>
	 */
	 ...
	 * enum values<br>
	 * <i>native declaration :
	 * /home/fschuett/prog/java/eclipse/ffmpeg/csrc/libavutil/frame.h:15</i>
	 */
	 ...
	 * enum values<br>
	 * <i>native declaration :
	 * /home/fschuett/prog/java/eclipse/ffmpeg/csrc/libavutil/frame.h:24</i>
	 */
	 ...
	 * enum values<br>
	 * <i>native declaration :
	 * /home/fschuett/prog/java/eclipse/ffmpeg/csrc/libavutil/frame.h:28</i>
	 */
	public enum AVFrameSideDataType implements
			IntValuedEnum<AVFrameSideDataType> {
	 ...
	 * enum values<br>
	 * <i>native declaration :
	 * /home/fschuett/prog/java/eclipse/ffmpeg/csrc/libavutil/opt.h:20</i>
	 */
	public enum AVOptionType implements IntValuedEnum<AVOptionType> {
		AV_OPT_TYPE_FLAGS(0), AV_OPT_TYPE_INT(1), AV_OPT_TYPE_INT64(2), AV_OPT_TYPE_DOUBLE(
				3), AV_OPT_TYPE_FLOAT(4), AV_OPT_TYPE_STRING(5), AV_OPT_TYPE_RATIONAL(
				6),
		/**
		 * < offset must point to a pointer immediately followed by an int for
		 * the length
		 */
		AV_OPT_TYPE_BINARY(7), AV_OPT_TYPE_CONST(128),
		/** < offset must point to two consecutive integers */
		AV_OPT_TYPE_IMAGE_SIZE(
				(('E') | (('Z') << 8) | (('I') << 16) | ('S' << 24))), AV_OPT_TYPE_PIXEL_FMT(
				(('T') | (('M') << 8) | (('F') << 16) | ('P' << 24))), AV_OPT_TYPE_SAMPLE_FMT(
				(('T') | (('M') << 8) | (('F') << 16) | ('S' << 24))),
		/** < offset must point to AVRational */
		AV_OPT_TYPE_VIDEO_RATE(
				(('T') | (('A') << 8) | (('R') << 16) | ('V' << 24))), AV_OPT_TYPE_DURATION(
				((' ') | (('R') << 8) | (('U') << 16) | ('D' << 24))), AV_OPT_TYPE_COLOR(
				(('R') | (('L') << 8) | (('O') << 16) | ('C' << 24))), AV_OPT_TYPE_CHANNEL_LAYOUT(
				(('A') | (('L') << 8) | (('H') << 16) | ('C' << 24)));
	 ...
	 * enum values<br>
	 * <i>native declaration :
	 * /home/fschuett/prog/java/eclipse/ffmpeg/csrc/libavutil/log.h:13</i>
	 */
	public enum AVClassCategory implements IntValuedEnum<AVClassCategory> {
		AV_CLASS_CATEGORY_NA(0), AV_CLASS_CATEGORY_INPUT(1), AV_CLASS_CATEGORY_OUTPUT(
				2), AV_CLASS_CATEGORY_MUXER(3), AV_CLASS_CATEGORY_DEMUXER(4), AV_CLASS_CATEGORY_ENCODER(
				5), AV_CLASS_CATEGORY_DECODER(6), AV_CLASS_CATEGORY_FILTER(7), AV_CLASS_CATEGORY_BITSTREAM_FILTER(
				8), AV_CLASS_CATEGORY_SWSCALER(9), AV_CLASS_CATEGORY_SWRESAMPLER(
				10), AV_CLASS_CATEGORY_NB(11);
	 ...
	 * enum values<br>
	 * <i>native declaration :
	 * /home/fschuett/prog/java/eclipse/ffmpeg/csrc/libavutil/pixfmt.h:315</i>
	 */
	public enum AVPixelFormat implements IntValuedEnum<AVPixelFormat> {
		 ...
		 * PIX_FMT_YUV420P and setting color_range
		 */
		AV_PIX_FMT_YUVJ420P(12),
		/**
		 * < planar YUV 4:2:2, 16bpp, full scale (JPEG), deprecated in favor of
		 * PIX_FMT_YUV422P and setting color_range
		 */
		AV_PIX_FMT_YUVJ422P(13),
		/**
		 * < planar YUV 4:4:4, 24bpp, full scale (JPEG), deprecated in favor of
		 * PIX_FMT_YUV444P and setting color_range
		 */
		AV_PIX_FMT_YUVJ444P(14),
		/** < XVideo Motion Acceleration via common packet passing */
		AV_PIX_FMT_XVMC_MPEG2_MC(15), AV_PIX_FMT_XVMC_MPEG2_IDCT(16),
		 ...
		 * contains two pixels, the first pixel in the byte is the one composed
		 * by the 4 msb bits
		 */
		AV_PIX_FMT_BGR4(20),
		 ...
		 * components, which are interleaved (first byte U and the following
		 * byte V)
		 */
		AV_PIX_FMT_NV12(25),
		...
		/**
		 * < planar YUV 4:4:0 full scale (JPEG), deprecated in favor of
		 * PIX_FMT_YUV440P and setting color_range
		 */
		...
		/**
		 * < HW decoding through VA API, Picture.data[3] contains a
		 * vaapi_render_state struct which contains the bitstream of the slices
		 ...
		 * FFmpeg supports these formats since May 8 2012 and Jan 28 2012
		 * (commits f9ca1ac7 and 143a5c55)<br>
		 * Libav added them Oct 12 2012 with incompatible values (commit
		 * 6d5600e85)<br>
		...
		/**
		 * < HW acceleration through VDPAU, Picture.data[3] contains a
		 * VdpVideoSurface
		 */
		AV_PIX_FMT_VDPAU(103),
		/**
		 * < packed XYZ 4:4:4, 36 bpp, (msb) 12X, 12Y, 12Z (lsb), the 2-byte
		 * value for each X/Y/Z is stored as little-endian, the 4 lower bits are
		 * set to 0
		 */
		AV_PIX_FMT_XYZ12LE(104),
		/**
		 * < packed XYZ 4:4:4, 36 bpp, (msb) 12X, 12Y, 12Z (lsb), the 2-byte
		 * value for each X/Y/Z is stored as big-endian, the 4 lower bits are
		 * set to 0
		 */
		AV_PIX_FMT_XYZ12BE(105),
		/**
		 * < interleaved chroma YUV 4:2:2, 16bpp, (1 Cr & Cb sample per 2x1 Y
		 * samples)
		 */
		AV_PIX_FMT_NV16(106),
		/**
		 * < interleaved chroma YUV 4:2:2, 20bpp, (1 Cr & Cb sample per 2x1 Y
		...
		/**
		 * < planar YUV 4:1:1, 12bpp, (1 Cr & Cb sample per 4x1 Y samples) full
		 * scale (JPEG), deprecated in favor of PIX_FMT_YUV411P and setting
		 * color_range
		 */
	 ...
	 * enum values<br>
	 * <i>native declaration :
	 * /home/fschuett/prog/java/eclipse/ffmpeg/csrc/libavutil/samplefmt.h:24</i>
	 */
	...
	/**
	 * <i>native declaration :
	 * /home/fschuett/prog/java/eclipse/ffmpeg/csrc/libavutil/avutil.h</i>
	 */
	public static final int AV_TIME_BASE = (int) 1000000;
	/**
	 * <i>native declaration :
	 * /home/fschuett/prog/java/eclipse/ffmpeg/csrc/libavutil/dict.h</i>
	 */
	...
	/**
	 * <i>native declaration :
	 * /home/fschuett/prog/java/eclipse/ffmpeg/csrc/libavutil/frame.h</i>
	 */
	public static final int AV_NUM_DATA_POINTERS = (int) 8;
	/**
	 * <i>native declaration :
	 * /home/fschuett/prog/java/eclipse/ffmpeg/csrc/libavutil/timestamp.h</i>
	 */
	public static final int AV_TS_MAX_STRING_SIZE = (int) 32;

	/**
	 * Original signature :
	 * <code>void av_dict_copy(AVDictionary**, AVDictionary*, int)</code><br>
	 * <i>native declaration :
	 * /home/fschuett/prog/java/eclipse/ffmpeg/csrc/libavutil/dict.h:8</i>
	 */
	public void av_dict_copy(Pointer<Pointer<AVDictionary>> dst,
			Pointer<AVDictionary> src, int flags) {
	 ...
	 * <i>native declaration :
	 * /home/fschuett/prog/java/eclipse/ffmpeg/csrc/libavutil/dict.h:10</i>
	 */
	...
	/**
	 * Original signature :
	 * <code>int av_reduce(int*, int*, int64_t, int64_t, int64_t)</code><br>
	 * <i>native declaration :
	 * /home/fschuett/prog/java/eclipse/ffmpeg/csrc/libavutil/rational.h:7</i>
	 */
	public int av_reduce(Pointer<Integer> dst_num, Pointer<Integer> dst_den,
			long num, long den, long max) {
		return av_reduce(Pointer.getPeer(dst_num), Pointer.getPeer(dst_den),
				num, den, max);
	}

	public native int av_reduce(@Ptr long dst_num, @Ptr long dst_den, long num,
			long den, long max);

	/**
	 * Original signature : <code>AVRational av_d2q(double, int)</code><br>
	 * <i>native declaration :
	 * /home/fschuett/prog/java/eclipse/ffmpeg/csrc/libavutil/rational.h:9</i>
	 */
	 ...
	 * <i>native declaration :
	 * /home/fschuett/prog/java/eclipse/ffmpeg/csrc/libavutil/opt.h:61</i>
	 */
	 ...
	 * <i>native declaration :
	 * /home/fschuett/prog/java/eclipse/ffmpeg/csrc/libavutil/opt.h:63</i>
	 */
	...
	/**
	 * Original signature :
	 * <code>int av_opt_set_dict(void*, AVDictionary**)</code><br>
	 * <i>native declaration :
	 * /home/fschuett/prog/java/eclipse/ffmpeg/csrc/libavutil/opt.h:65</i>
	 */
	public int av_opt_set_dict(Pointer<?> obj,
	 ...
	 * <i>native declaration :
	 * /home/fschuett/prog/java/eclipse/ffmpeg/csrc/libavutil/mem.h:1</i>
	 */
	 ...
	 * <i>native declaration :
	 * /home/fschuett/prog/java/eclipse/ffmpeg/csrc/libavutil/mem.h:3</i>
	 */
	 ...
	 * <i>native declaration :
	 * /home/fschuett/prog/java/eclipse/ffmpeg/csrc/libavutil/samplefmt.h:26</i>
	 */
	public Pointer<Byte> av_get_sample_fmt_name(
			IntValuedEnum<AvutilLibrary.AVSampleFormat> sample_fmt) {
		return Pointer.pointerToAddress(
				av_get_sample_fmt_name((int) sample_fmt.value()), Byte.class);
	}
	 ...
	 * <i>native declaration :
	 * /home/fschuett/prog/java/eclipse/ffmpeg/csrc/libavutil/samplefmt.h:28</i>
	 */
	public int av_sample_fmt_is_planar(
			IntValuedEnum<AvutilLibrary.AVSampleFormat> sample_fmt) {
	 ...
	 * <i>native declaration :
	 * /home/fschuett/prog/java/eclipse/ffmpeg/csrc/libavutil/samplefmt.h:30</i>
	 */
	public int av_get_bytes_per_sample(
			IntValuedEnum<AvutilLibrary.AVSampleFormat> sample_fmt) {
	...
	/**
	 * Original signature :
	 * <code>AVSampleFormat av_get_sample_fmt(const char*)</code><br>
	 * <i>native declaration :
	 * /home/fschuett/prog/java/eclipse/ffmpeg/csrc/libavutil/samplefmt.h:32</i>
	 */
	public IntValuedEnum<AvutilLibrary.AVSampleFormat> av_get_sample_fmt(
			Pointer<Byte> name) {
		return FlagSet.fromValue(av_get_sample_fmt(Pointer.getPeer(name)),
				AvutilLibrary.AVSampleFormat.class);
	}
	 ...
	 * <i>native declaration :
	 * /home/fschuett/prog/java/eclipse/ffmpeg/csrc/libavutil/samplefmt.h:34</i>
	 */
	public IntValuedEnum<AvutilLibrary.AVSampleFormat> av_get_packed_sample_fmt(
			IntValuedEnum<AvutilLibrary.AVSampleFormat> sample_fmt) {
		return FlagSet.fromValue(
				av_get_packed_sample_fmt((int) sample_fmt.value()),
				AvutilLibrary.AVSampleFormat.class);
	}
	...
	/**
	 * Original signature :
	 * <code>void av_image_copy(uint8_t*[4], int[4], const uint8_t*[4], const int[4], AVPixelFormat, int, int)</code>
	 * <br>
	 * <i>native declaration :
	 * /home/fschuett/prog/java/eclipse/ffmpeg/csrc/libavutil/imgutils.h:1</i>
	 */
	public void av_image_copy(Pointer<Pointer<Byte>> dst_data,
			Pointer<Integer> dst_linesizes, Pointer<Pointer<Byte>> src_data,
			Pointer<Integer> src_linesizes,
			IntValuedEnum<AvutilLibrary.AVPixelFormat> pix_fmt, int width,
			int height) {
		av_image_copy(Pointer.getPeer(dst_data),
				Pointer.getPeer(dst_linesizes), Pointer.getPeer(src_data),
				Pointer.getPeer(src_linesizes), (int) pix_fmt.value(), width,
				height);
	}
	...
	/**
	 * Original signature :
	 * <code>char* av_get_pix_fmt_name(AVPixelFormat)</code><br>
	 * <i>native declaration :
	 * /home/fschuett/prog/java/eclipse/ffmpeg/csrc/libavutil/pixdesc.h:1</i>
	 */
	public Pointer<Byte> av_get_pix_fmt_name(
			IntValuedEnum<AVPixelFormat> pix_fmt) {
		return Pointer.pointerToAddress(
				av_get_pix_fmt_name((int) pix_fmt.value()), Byte.class);
	}
	...
	public Pointer<Byte> av_ts_make_string(Pointer<Byte> buf, long ts) {
		...
		if (ts == AV_NOPTS_VALUE)
			System.arraycopy("NOPTS", 0, buf, 0, "NOPTS".length());
		else
			System.arraycopy(Long.toHexString(ts), 0, buf, 0,
					Long.toHexString(ts).length());
		return buf;
	}
	...
	public Pointer<Byte> av_ts_make_time_string(Pointer<Byte> buf, long ts,
			AVRational tb) {
		if (ts == AV_NOPTS_VALUE)
			System.arraycopy("NOPTS", 0, buf, 0, "NOPTS".length());
		else {
